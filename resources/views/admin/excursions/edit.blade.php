                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-3">
                            ...
                            <form action="{{ route('admin.excursions.update', $excursion->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ old('active_days_for_booking') ?? $excursion->active_days_for_booking }}" name="active_days_for_booking" class="form-control" placeholder="Количество дней для записи">
